...
type User struct {
	Id          string     `yaml:"id" mapstructure:"id" json:"id,omitempty" gorm:"column:id;primary_key" bson:"_id,omitempty" dynamodbav:"id" firestore:"-" avro:"id" validate:"required,max=40" operator:"="`
